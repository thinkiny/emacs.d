...
(defvar nov-xwidget-webkit-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "v") #'nov-xwidget-find-source-file)
    (define-key map (kbd "N") #'nov-xwidget-next-document)
    (define-key map (kbd "P") #'nov-xwidget-previous-document)
    (define-key map (kbd "n") #'nov-xwidget-next-line-or-page)
    (define-key map (kbd "j") #'nov-xwidget-next-line-or-page)
    (define-key map (kbd "G") #'xwidget-webkit-scroll-bottom)
    (define-key map (kbd "p") #'nov-xwidget-previous-line-or-page)
    (define-key map (kbd "k") #'nov-xwidget-previous-line-or-page)
    (define-key map (kbd "o") #'nov-xwidget-goto-toc)
    map)
