...
(defun open-webpage-in-chrome(&optional rest)
  (interactive)
...
(with-eval-after-load 'xwidget
  ...
  (define-key xwidget-webkit-mode-map (kbd "p") 'xwidget-scroll-down-line)
  (define-key xwidget-webkit-mode-map (kbd "j") 'xwidget-scroll-up-line)
  (define-key xwidget-webkit-mode-map (kbd "k") 'xwidget-scroll-down-line)
  (define-key xwidget-webkit-mode-map (kbd "s") 'xwidget-scroll-up-line)
  (define-key xwidget-webkit-mode-map (kbd "w") 'xwidget-scroll-down-line)
  (define-key xwidget-webkit-mode-map (kbd "v") 'xwidget-scroll-up)
  (define-key xwidget-webkit-mode-map (kbd "M-v") 'xwidget-scroll-down)
  ...
  (define-key xwidget-webkit-mode-map (kbd "C-v") 'xwidget-scroll-up)
