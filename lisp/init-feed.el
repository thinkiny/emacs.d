...
browser defined by `browse-url-generic-program'."
  ...
  (defun my-elfeed-show-mode-hook()
    ...
    (define-key elfeed-show-mode-map (kbd "n") #'scroll-up-line)
    ...
    (define-key elfeed-show-mode-map (kbd "p") #'scroll-down-line)
    (define-key elfeed-show-mode-map (kbd "j") #'scroll-up-line)
    (define-key elfeed-show-mode-map (kbd "k") #'scroll-down-line)
    (define-key elfeed-show-mode-map (kbd "w") #'scroll-down-line)
    (define-key elfeed-show-mode-map (kbd "s") #'scroll-up-line)
