...
browser defined by `browse-url-generic-program'."
  ...
  (defun my-elfeed-show-mode-hook()
    ...
    (define-key elfeed-show-mode-map (kbd "n") #'pixel-forward-line)
    ...
    (define-key elfeed-show-mode-map (kbd "p") #'pixel-backward-line)
    (define-key elfeed-show-mode-map (kbd "j") #'pixel-forward-line)
    (define-key elfeed-show-mode-map (kbd "k") #'pixel-backward-line)
    (define-key elfeed-show-mode-map (kbd "w") #'pixel-backward-line)
    (define-key elfeed-show-mode-map (kbd "s") #'pixel-forward-line)
    (define-key elfeed-show-mode-map (kbd "g") #'elfeed-show-yank)
