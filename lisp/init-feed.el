...
browser defined by `browse-url-generic-program'."
  ...
  (defun my-elfeed-show-mode-hook()
    ...
    (define-key elfeed-show-mode-map (kbd "n") #'pxiel-scroll-up-line)
    ...
    (define-key elfeed-show-mode-map (kbd "j") #'pixel-scroll-up-line)
    (define-key elfeed-show-mode-map (kbd "k") #'pixel-scroll-down-line)
    (define-key elfeed-show-mode-map (kbd "w") #'pixel-scroll-down-line)
    (define-key elfeed-show-mode-map (kbd "s") #'pixel-scroll-up-line)
